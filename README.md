...
-   You will need to download and install [FFmpeg](https://ffmpeg.org/download.html) in order to use the [asset-helper.cmd](../blob/main/assets/asset-helper.cmd) script.
